...
describe("EquipmentService", () => {
  ...
  describe("findById", () => {
    ...
    it("should throw EquipmentNotFoundError when equipment doesn't exist", async () => {
      ...
      await expect(equipmentService.findById("1")).rejects.toThrow(
  ...
  describe("create", () => {
    ...
    it("should throw InvalidForeignKeyError when save fails with foreign key error", async () => {
      ...
      await expect(equipmentService.create(equipmentData)).rejects.toThrow(
  ...
  describe("update", () => {
    ...
    it("should throw EquipmentNotFoundError when equipment doesn't exist", async () => {
      ...
      await expect(
        equipmentService.update(equipmentId, updateData)
  ...
  describe("delete", () => {
    ...
    it("should throw EquipmentNotFoundError when equipment doesn't exist", async () => {
      ...
      await expect(equipmentService.delete(equipmentId)).rejects.toThrow(
        EquipmentNotFoundError
      );
    });

...
import { PartType } from "../../../../shared/models/Part";
...
describe("PartService", () => {
  ...
  describe("findById", () => {
    ...
    it("should throw PartNotFoundError when part doesn't exist", async () => {
      ...
      await expect(partService.findById("1")).rejects.toThrow(
        PartNotFoundError
      );
    });
  });
  ...
  describe("create", () => {
    ...
    it("should throw InvalidForeignKeyError when save fails with foreign key error", async () => {
      ...
      await expect(partService.create(partData)).rejects.toThrow(
  ...
  describe("update", () => {
    ...
    it("should throw PartNotFoundError when part doesn't exist", async () => {
      ...
      await expect(partService.update(partId, updateData)).rejects.toThrow(
        PartNotFoundError
      );
    });
  ...
  describe("delete", () => {
    ...
    it("should throw PartNotFoundError when part doesn't exist", async () => {
      ...
      await expect(partService.delete(partId)).rejects.toThrow(
        PartNotFoundError
      );
    });
